export default function Footer() {
  return (
    <div className="footer-div">
      <div className="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5 margin-top9">
        <div className="row pt-5">
          <div className="col-lg-3 col-md-6 mb-5">
            ...
            <h6 className="text-white text-uppercase mt-4 mb-3 letterspace">
              Follow Us
            </h6>
          ...
          <div className="col-lg-3 col-md-6 mb-5">
            <h5 className="text-white text-uppercase mb-4 letterspace">
              Our Services
            </h5>
      ...
      <div className="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5 border-col">
        <div className="row">
          <div className="col-lg-6 text-center text-md-left mb-3 mb-md-0">
            <p className="m-0 text-white-50">
              Copyright &copy; Domain. All Rights Reserved.
            </p>
          </div>
          <div className="col-lg-6 text-center text-md-right">
            <p className="m-0 text-white-50">
              Designed by{" "}
              <a href="https://abdulla-hussain.github.io">Hussain</a>
            </p>
          </div>
        </div>
      </div>
